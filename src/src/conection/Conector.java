...
public class Conector {
    ...
    public void insertContact(Contactos conta) throws Exception {//metodo para guardar dentro de la tabla contactos
        ...
        try {
            String url = ("jdbc:mysql://localhost/softwareCelestial?"
                    + "user=root&password=");//direccion de BD
            con = DriverManager.getConnection(url);
            stmt = con.createStatement();

            insert = con.prepareStatement("INSERT INTO CONTACTO (IDCONTACTO,NOMBRE,PUESTO,TELEFONOS,CORREO)" + " values(?,?,?,?,?)");
    ...
    public void insertEmpresa(Empresa em) throws Exception {//metodo para guardar dentro de la tabla contactos
        ...
        try {
            ...
            insert = con.prepareStatement("INSERT INTO EMPRESA (IDEMPRESA,RAZONSOCIAL,TELEFONOS,UBICACION,LOGO,DIRECCION" + " values(?,?,?,?,?,?)");
    ...
    public void insertCaracteristicaMejor(CaracteristicasVer caraVerMejora) throws Exception {//metodo para guardar dentro de la tabla contactos
    ...
    public void insertInstalacion(Instalacion insta) throws Exception {//metodo para guardar dentro de la tabla contactos
    ...
    public static void listContact() {
        try {
            ...
            Connection conn = conn = DriverManager.getConnection("jdbc:mysql://localhost/softwareCelestial?"
                    + "user=root&password=");
